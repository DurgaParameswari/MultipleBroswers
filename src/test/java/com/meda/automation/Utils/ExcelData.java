...
public class ExcelData {
	...
	public static void mita_description_excelData() throws Exception {
		try {
			...
			logger.warn("Executing - "+ 
					Driver_Script.Actionvalue + ": Unable to read the description from excel data " + e.getMessage());
		}
	}

	public static void mita_Enter_excelData() throws Exception {
		try {
			logger.info("Executing - "+ Driver_Script.Actionvalue + ": Reading locator value and test data from excel");
			cell2 = row.getCell(1);
			...
			logger.warn("Executing - "+ Driver_Script.Actionvalue + ": Unable to read the locator value and test data from excel "
					+ e.getMessage());
		}
	}
	...
	public static void mita_Click_excelData() {
		try {
			...
			logger.warn("Executing - "+ Driver_Script.Actionvalue + ": Unable to read the locator value from excel " + e.getMessage());
		}
	}
	...
	public static void mita_ValidateTitle() {
		try {
			...
			logger.warn("Executing - "+ Driver_Script.Actionvalue + ": Unable to read the test data from excel " + e.getMessage());
		}
	}
	...
	public static void mita_stepName() {
		try {
			...
			logger.warn("Executing - "+ Driver_Script.Actionvalue + ": Unable to read the description from excel " + e.getMessage());
		}
	}
