					...
					for (j = 0; j < sheetNames.length; j++) {
						...
						while (i <= lastRow) {
							...
							if (type.equalsIgnoreCase("Mobile")) {
								...
								reporterLog("Mobile Execution Starting:");
								...
								try {
									for (k = i + 1; k <= lastRow; k++) {
										...
										if (Actionvalue.toLowerCase().contains("apk")) {
											...
											mita_Mobile_write();
										} else if (Actionvalue.toLowerCase().contains("enter")
												|| Actionvalue.toLowerCase().contains("insert")
												|| Actionvalue.toLowerCase().contains("inserting")
												|| Actionvalue.toLowerCase().contains("entering")
												|| Actionvalue.toLowerCase().contains("input")
												|| Actionvalue.toLowerCase().contains("editing")
												|| Actionvalue.toLowerCase().contains("put")) {
											mita_Enter_excelData();
											Machint_Mobile_EnterTextField("xpath", LocatorId, Entervalue,
													"visibilityOf");
										...
										} else if (Actionvalue.toLowerCase().contains("click")
												|| Actionvalue.toLowerCase().contains("hit")
											...
											Machint__Mobile_selectValue("xpath", LocatorId, SelectValue,
													"visibilityOf");
											...
											Machint_Mobile_SetTheSecondValue("xpath", LocatorId, "visibilityOf");
												...
												|| Actionvalue.toLowerCase().contains("check")
												|| Actionvalue.toLowerCase().contains("checking")
												|| Actionvalue.toLowerCase().contains("find")
												|| Actionvalue.toLowerCase().contains("finding")
											...
											mita_Enter_excelData();
											Machint_Mobile_generateRandomNumber("xpath", LocatorId, Entervalue,
													"visibilityOf");
										} else if (Actionvalue.toLowerCase().contains("zero")) {
											mita_Enter_excelData();
											Machint_Mobile_zeroStartsNumber("xpath", LocatorId, Entervalue,
													"visibilityOf");
										...
										} else if (Actionvalue.toLowerCase().contains("append")
												|| Actionvalue.toLowerCase().contains("prefix")
												|| Actionvalue.toLowerCase().contains("pre fix")
												|| Actionvalue.toLowerCase().contains("pre-fix")
												|| Actionvalue.toLowerCase().contains("affix")
										...
										} else if (Actionvalue.toLowerCase().contains("wait")
												|| Actionvalue.toLowerCase().contains("standby")
												|| Actionvalue.toLowerCase().contains("holdback")
												|| Actionvalue.toLowerCase().contains("pause")
												|| Actionvalue.toLowerCase().contains("halt")
												|| Actionvalue.toLowerCase().contains("give a break")
												|| Actionvalue.toLowerCase().contains("delay")
												|| Actionvalue.toLowerCase().contains("hold on")
...
//									System.out.println("Mobile-Please do spell ckeck");
									...
									reporterLog("Mobile-Please do spell ckeck");
									mita_Mobile_Please_do_Spellcheck();
								...
								try {
									...
									reporterLog("WEB Execution Starting");
									mita_executionType(type);
									for (k = i + 1; k <= lastRow; k++) {
										row = sheet.getRow(k);
										cell0 = row.getCell(0);
										...
										if (Actionvalue.toLowerCase().contains("url")) {
											...
											mita_Enter_excelData();
											mita_AutoSuggestion_Dropdown("xpath", LocatorId, Entervalue,
													"visibilityOf");
										} else if (Actionvalue.toLowerCase().contains("index")) {
											mita_Select_ExcelData();
											...
											mita_Enter_excelData();
											machintWeb_Mobile_Number_OTP("xpath", LocatorId, Entervalue,
													"visibilityOf");
										} else if (Actionvalue.toLowerCase().contains("random")) {
											mita_Enter_excelData();
											Machint_Web_generateRandomNumber("xpath", LocatorId, Entervalue,
													"visibilityOf");
										} else if (Actionvalue.toLowerCase().contains("zero")) {
											mita_Enter_excelData();
...
//									System.out.println("WEB-Please do spell ckeck");
									...
									reporterLog("WEB-Please do spell ckeck");
								}
							}
						}
					}
